...
int main()
{
	...
	textureBackground.loadFromFile("/home/student/8160_gpwc/project/graphics/couragehomee.png");
	...
	sf::Font font;
	font.loadFromFile("/home/student/8160_gpwc/project/fonts/KOMIKAP_.ttf");
	...
	spritePlayer.setPosition(1190, 620);
	...
	Texture textureRIP;
	textureRIP.loadFromFile("/home/student/8160_gpwc/project/graphics/puneet.png");
	Sprite spriteRIP;
	...
	chopBuffer.loadFromFile("/home/student/8160_gpwc/project/sound/mariojump.wav");
	Sound chop;
	chop.setBuffer(chopBuffer);

	SoundBuffer deathBuffer;
	deathBuffer.loadFromFile("/home/student/8160_gpwc/project/sound/deathh.wav");
	Sound death;
	death.setBuffer(deathBuffer);

	// Out of time
	SoundBuffer ootBuffer;
	ootBuffer.loadFromFile("/home/student/8160_gpwc/project/sound/plankton.wav");
	Sound outOfTime;
		...
		*/
		if (!paused)
		{
			...
			if (branchPositions[5] == playerSide)
			{
				...
				messageText.setString("KOI BAAT NAHI MITRR!!");
